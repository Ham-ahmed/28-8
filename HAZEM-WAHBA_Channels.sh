...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/28-8/refs/heads/main/channels_backup_OpenBlackhole_20250827_HAZEMWAHBA-Ciefp.tar.gz"
